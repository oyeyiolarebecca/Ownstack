...
import { Users } from "lucide-react"; // For fallback icons
    ...
    async function uploadAvatar(
        ...
        try {
            ...
            if (uploadError) {
                ...
                alert(`Upload failed: ${uploadError.message}\nFull Error: ${JSON.stringify(uploadError)}`);
                throw uploadError;
            }
            ...
            // Optionally save the profile immediately or let user click "Save"
            // For better UX, let's keep it in memory until user clicks "Save Profile"

        } catch (error: any) {
            console.error("Profile picture upload failed:", error);
            alert(error.message || "Upload failed. Please check if your storage bucket 'avatars' is public and has proper RLS policies.");
        } finally {
            ...
            <div className="flex-1 p-8">
                ...
                <div className="grid lg:grid-cols-2 gap-10 mt-10 max-w-6xl">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    type="text"
                                    placeholder="e.g. Green Valley Coffee"
                            ...
                            <button
                                onClick={saveProfile}
                                disabled={loading}
                                className="w-full bg-slate-900 border border-slate-900 hover:bg-slate-800 text-white px-6 py-4 rounded-2xl font-bold transition active:scale-95 shadow-lg shadow-slate-200"
                            >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/50 border border-dashed border-slate-200 rounded-3xl p-6 text-center">
