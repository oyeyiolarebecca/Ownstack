  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#060b16] px-6 py-12 text-white">
      ...
      <section className="relative w-full max-w-md rounded-2xl border border-slate-800 bg-[#050914]/95 p-8 shadow-2xl shadow-black/30">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-normal">Connect your identity</h1>
        <p className="mt-4 text-base font-medium leading-7 text-slate-300">Open your business dashboard with your Nostr key and restore your ledger from public relays.</p>
